...
#define ARM_MMU700_MAX_TBUS		62

#define ARM_MMU700_TCU_STATUS		0x8e10
#define TCU_STATUS_GNT_XLATE_SLOTS	GENMASK(16, 4)

#define ARM_MMU700_TCU_SCR		0x8e18
#define TCU_SCR_NS_UARCH		(1 << 0)

#define ARM_MMU700_TCU_SYSDISC9		0x8e58
#define TCU_SYSDISC9_TCUCFG_NUM_TBU	GENMASK(5, 0)

#define ARM_MMU700_TCU_NODE_STATUS(n)	(0x9400 + 4 * (n))
#define TCU_NODE_STATUS_CONNECTED	(1 << 0)
...
#define ARM_SMMU_FEAT_PERMS_OVR		(1 << 21)

/*
 * SMMU driver options, not a hardware regs, but common to EL1/EL2 drivers
 * so there is no really a suitable place for these.
 */
