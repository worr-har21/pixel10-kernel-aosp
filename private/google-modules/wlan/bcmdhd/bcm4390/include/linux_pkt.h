...
#define PKTISTXFRAGSPPROBE(skb)		({BCM_REFERENCE(skb); 0; })
#define PKTSETTXFRAGSPPROBE(skb, idx)	({BCM_REFERENCE(skb); BCM_REFERENCE(idx); })
#define PKTRESETTXFRAGSPPROBE(skb)	({BCM_REFERENCE(skb); })
