...
EXPORT_SYMBOL_GPL(wm_adsp_fw_get_v1);
...
EXPORT_SYMBOL_GPL(wm_adsp_fw_put_v1);

const struct soc_enum wm_adsp_fw_enum_v1[] = {
...
EXPORT_SYMBOL_GPL(wm_adsp_fw_enum_v1);
...
EXPORT_SYMBOL_GPL(wm_adsp_write_ctl_v1);
...
EXPORT_SYMBOL_GPL(wm_adsp_read_ctl_v1);
					 ...
					 const char *filetype)
{
	...
	if (dsp->tuning_has_prefix && asoc_component_prefix)
		*filename = kasprintf(GFP_KERNEL, "%s%s-%s-%s-%s.%s", dir, dsp->part,
				      dsp->fwf_name, wm_adsp_fw[dsp->fw].file,
				      asoc_component_prefix, filetype);	
	else if (system_name && asoc_component_prefix)
...
EXPORT_SYMBOL_GPL(wm_adsp1_init_v1);
...
EXPORT_SYMBOL_GPL(wm_adsp1_event_v1);
...
EXPORT_SYMBOL_GPL(wm_adsp2_set_dspclk_v1);
...
EXPORT_SYMBOL_GPL(wm_adsp2_preloader_get_v1);
...
EXPORT_SYMBOL_GPL(wm_adsp2_preloader_put_v1);
...
EXPORT_SYMBOL_GPL(wm_adsp_early_event_v1);
...
EXPORT_SYMBOL_GPL(wm_adsp_event_v1);
...
EXPORT_SYMBOL_GPL(wm_adsp2_component_probe_v1);
...
EXPORT_SYMBOL_GPL(wm_adsp2_component_remove_v1);
...
EXPORT_SYMBOL_GPL(wm_adsp2_init_v1);
...
EXPORT_SYMBOL_GPL(wm_halo_init_v1);

void wm_adsp2_remove_v1(struct wm_adsp *dsp)
{
	cs_dsp_remove(&dsp->cs_dsp);
}
EXPORT_SYMBOL_GPL(wm_adsp2_remove_v1);
...
EXPORT_SYMBOL_GPL(wm_adsp_compr_open_v1);
...
EXPORT_SYMBOL_GPL(wm_adsp_compr_free_v1);
...
EXPORT_SYMBOL_GPL(wm_adsp_compr_set_params_v1);
...
EXPORT_SYMBOL_GPL(wm_adsp_compr_get_caps_v1);
...
EXPORT_SYMBOL_GPL(wm_adsp_compr_trigger_v1);
...
EXPORT_SYMBOL_GPL(wm_adsp_compr_handle_irq_v1);

static int wm_adsp_buffer_reenable_irq_v1(struct wm_adsp_compr_buf *buf)
{
			  ...
			  struct snd_compr_tstamp *tstamp)
{
	...
	if (buf->avail < wm_adsp_compr_frag_words(compr)) {
		...
		if (buf->avail < wm_adsp_compr_frag_words(compr)) {
			...
			ret = wm_adsp_buffer_reenable_irq_v1(buf);
			if (ret < 0) {
...
EXPORT_SYMBOL_GPL(wm_adsp_compr_pointer_v1);
...
EXPORT_SYMBOL_GPL(wm_adsp_compr_copy_v1);
...
EXPORT_SYMBOL_GPL(wm_adsp2_bus_error_v1);
...
EXPORT_SYMBOL_GPL(wm_halo_bus_error_v1);
...
EXPORT_SYMBOL_GPL(wm_halo_wdt_expire_v1);
