...
#ifndef __GANYMEDE_IOVA_H__
#define __GANYMEDE_IOVA_H__
...
#define GXP_MCU_BOOT_MODE_SIZE (0x04)
#define GXP_MCU_DUMP_CONFIG_OFFSET (GXP_MCU_BOOT_MODE_OFFSET + GXP_MCU_BOOT_MODE_SIZE)
#define GXP_IREMAP_DYNAMIC_CODE_BASE 0x11000000

#endif /* __GANYMEDE_IOVA_H__ */
