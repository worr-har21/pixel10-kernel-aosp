			       ...
			       unsigned int quot, unsigned int quot_frac)
{
	...
	google_serial8250_do_set_divisor(p, baud, quot, quot_frac);
}

void google_dw8250_do_set_termios(struct uart_port *p, struct ktermios *termios,
			   const struct ktermios *old)
{
	...
	google_serial8250_do_set_termios(p, termios, old);
...
EXPORT_SYMBOL_GPL(google_dw8250_do_set_termios);
...
void google_dw8250_setup_port(struct uart_port *p)
{
	...
	if (pd->hw_rs485_support) {
		...
		p->rs485_config = google_serial8250_em485_config;
		p->rs485_supported = google_serial8250_em485_supported;
		up->rs485_start_tx = google_serial8250_em485_start_tx;
		up->rs485_stop_tx = google_serial8250_em485_stop_tx;
	}
...
EXPORT_SYMBOL_GPL(google_dw8250_setup_port);
