...
/*
 * pixel-debug-kinfo.c - use to backup debugging kernel information
 *
...
static void update_vendor_kernel_all_info(void)
{
	...
	info->suspend_diag_va = (__u64)google_cdd_suspend_diag_get_info();
...
static int pixel_debug_kinfo_probe(struct platform_device *pdev)
{
	int i;
...
static const struct of_device_id pixel_debug_kinfo_of_match[] = {
	{ .compatible	= "google,pixel-debug-kinfo" },
	{},
};
MODULE_DEVICE_TABLE(of, pixel_debug_kinfo_of_match);

static struct platform_driver pixel_debug_kinfo_driver = {
	.probe = pixel_debug_kinfo_probe,
	.driver = {
		.name = "pixel-debug-kinfo",
		.of_match_table = of_match_ptr(pixel_debug_kinfo_of_match),
	},
};
module_platform_driver(pixel_debug_kinfo_driver);

MODULE_AUTHOR("Jone Chou <jonechou@google.com>");
MODULE_DESCRIPTION("Pixel Debug Kinfo");
