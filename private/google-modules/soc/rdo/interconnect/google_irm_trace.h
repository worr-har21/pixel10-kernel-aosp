...
#undef TRACE_SYSTEM
#define TRACE_SYSTEM google_irm_trace

#if !defined(_TRACE_GOOGLE_IRM_H) || defined(TRACE_HEADER_MULTI_READ)
#define _TRACE_GOOGLE_IRM_H

#include <linux/tracepoint.h>

#define TPS(x)  tracepoint_string(x)

TRACE_EVENT(google_irm_event,
...
TRACE_EVENT(google_irm_event_with_ret,
...
#endif /* _TRACE_GOOGLE_IRM_H */

/* This part must be outside protection */
#undef TRACE_INCLUDE_PATH
#define TRACE_INCLUDE_PATH .
#define TRACE_INCLUDE_FILE google_irm_trace
