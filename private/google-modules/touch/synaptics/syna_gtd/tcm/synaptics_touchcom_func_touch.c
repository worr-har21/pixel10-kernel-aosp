...
/**
 * @brief   Get data entity from the Touch report.
 *          The touch config must be preserved; otherwise, ther is no
 *          way to parse the touch data
 *
 * @param
...
/**
 * @brief   Get data of knob data entity.
 *
 * @param
 *    [ in] report:       touch report generated by TouchComm device
...
/**
 * @brief   Get data of gesture data entity.
 *
 * @param
 *    [ in] report:       touch report generated by TouchComm device
 *    [ in] report_size:  size of given report
...
/**
 * @brief   Traverse through touch report configuration and parse the contents of
...
/**
 * @brief   Set up the custom touch report configuration.
 *
...
/**
 * @brief   Preserve the current touch report configuration defined in firmware.
...
/**
 * @brief   Register callback function to handle custom touch entity.
 *
 * @param
 *    [ in] tcm_dev:  the TouchComm device handle
...
int syna_tcm_set_custom_touch_entity_callback(struct tcm_dev *tcm_dev,
	tcm_custom_touch_entity_callback_t p_cb, void *private_data)
{
	if (!tcm_dev) {
		LOGE("Invalid tcm device handle\n");
		return -ERR_INVAL;
...
/**
 * @brief   Register callback function to handle custom gesture data.
 *
 * @param
 *    [ in] tcm_dev:  the TouchComm device handle
 *    [ in] p_cb:     the function pointer to callback
...
int syna_tcm_set_custom_gesture_callback(struct tcm_dev *tcm_dev,
	tcm_custom_gesture_callback_t p_cb, void *private_data)
{
	if (!tcm_dev) {
		LOGE("Invalid tcm device handle\n");
		return -ERR_INVAL;
